...
fn main() -> Result<()> {
    ...
    //     private: vec![
    //         120, 240, 8, 107, 4, 185, 126, 201, 133, 16, 101, 152, 99, 158, 63, 214, 150, 51, 193,
    //         91, 165, 120, 153, 28, 32, 129, 127, 21, 116, 67, 154, 72,
    //     ],
    //     public: vec![
    //         214, 198, 18, 186, 200, 111, 109, 137, 254, 215, 102, 184, 102, 236, 209, 194, 190,
    //         238, 174, 205, 51, 21, 223, 16, 1, 61, 17, 61, 149, 25, 218, 113,
    //     ],
    // };
    // let ephemeral_key = snow::Keypair {
    //     private: vec![
    //         0, 186, 224, 30, 112, 163, 17, 9, 150, 196, 164, 48, 193, 130, 58, 209, 59, 189, 214,
    //         87, 244, 225, 88, 176, 182, 164, 250, 105, 49, 96, 216, 87,
    //     ],
    //     public: vec![
    //         27, 111, 40, 69, 100, 222, 192, 208, 244, 2, 19, 37, 19, 202, 171, 102, 172, 72, 43,
    //         72, 169, 255, 143, 234, 53, 92, 126, 51, 40, 53, 16, 98,
    //     ],
    // };
    handshake_with_snow(&mut stream, &static_key, Some(&ephemeral_key))?;

    // handshake(&mut stream, &static_key, Some(&ephemeral_key))?;
